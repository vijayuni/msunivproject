...
# Assuming you have a list of original titles from your RSS feed entries
original_titles = [
...
# Assuming you have a list of paraphrased titles generated by your code
paraphrased_titles = [
...
# Calculate BLEU score for each paraphrased title
bleu_scores = []
for ref, cand in zip(original_titles, paraphrased_titles):
...
for i, score in enumerate(bleu_scores, start=1):
    print(f'BLEU Score for Paraphrased Title {i}: {score:.4f}')
