...
human_tokens = [nltk.word_tokenize(summary.lower()) for summary in human_summaries]
system_tokens = [nltk.word_tokenize(summary.lower()) for summary in system_summaries]

# Calculate METEOR score for each system-generated summary
meteor_scores = []
for system_tokens, human_tokens in zip(system_tokens, human_tokens):
    score = meteor_score.meteor_score([human_tokens], system_tokens)
